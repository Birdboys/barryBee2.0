...
func setField(radius, segments, platform_length=1.0):
	...
	frontRing.mesh.material.uv1_scale.x = 2 * (field_radius+field_platform_length/2.0 + 1)
	...
	backRing.mesh.material.uv1_scale.x = 2 * (field_radius+field_platform_length/2.0 + 1)
